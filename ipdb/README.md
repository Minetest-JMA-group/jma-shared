...
| `/ipdb merge_gui` | Open the merge history GUI (tree view, detail view, rollback with per-identifier decisions, and the storage an entry held at any point in its history). |
